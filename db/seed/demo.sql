...
VALUES
  ...
  (
    'demo-potato-harvest', 'US', 'PRODUCE',
    'Avi''s Potato Patch Harvest',
    'A small-batch potato harvest from Avi''s patch, packed for roasting, mashing, and sharing.',
    'Avi''s Potato Patch', 'Avi''s Potato Patch',
    '{"mpn":"AVI-POTATO-HARVEST"}',
    '{"grownBy":"Avi","season":"late-summer","organic":true}',
    '[{"url":"https://placehold.co/800x800/png?text=Avi%27s+Potatoes","alt":"Avi''s Potato Patch harvest","isPrimary":true}]',
    '["Small-batch harvest","Packed for freshness","Great for roasting or mashing"]',
    '{"value":2.5,"unit":"kg"}',
    '{"length":28,"width":20,"height":12,"unit":"cm"}',
    now()
  )
...
VALUES
  ...
  ('demo-potato-golden-russet', 'demo-seller', 'avis-potato-patch-golden-russet', 'US', 'AVI-POTATO-RUSSET', 1299, true, 'demo-potato-harvest', 'NEW', 2, 'color=golden-russet', '[{"url":"/demo-products/potato-golden-russet.webp","alt":"Avi Potato Patch golden russet potatoes","isPrimary":true}]', 18),
  ('demo-potato-purple-majesty', 'demo-seller', 'avis-potato-patch-purple-majesty', 'US', 'AVI-POTATO-PURPLE', 1499, true, 'demo-potato-harvest', 'NEW', 2, 'color=purple-majesty', '[{"url":"/demo-products/potato-purple-majesty.webp","alt":"Avi Potato Patch Purple Majesty potatoes","isPrimary":true}]', 11),
...
VALUES
  ...
  ('demo-potato-harvest-color', 'demo-potato-harvest', 'US', 'color', 'Color', 0, true),
...
VALUES
  ...
  ('demo-potato-harvest-color-golden-russet', 'demo-potato-harvest-color', 'golden-russet', 'Golden Russet', 0, '{"swatch":"#c99142"}'),
  ('demo-potato-harvest-color-purple-majesty', 'demo-potato-harvest-color', 'purple-majesty', 'Purple Majesty', 1, '{"swatch":"#6d3d78"}'),
...
VALUES
  ...
  ('demo-potato-golden-russet', 'demo-potato-harvest-color', 'demo-potato-harvest-color-golden-russet'),
  ('demo-potato-purple-majesty', 'demo-potato-harvest-color', 'demo-potato-harvest-color-purple-majesty'),
