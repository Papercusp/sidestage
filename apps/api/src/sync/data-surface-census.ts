...
export const POSTGRES_SURFACES = {
  ...
  targeted_offer: pg('targeted_offer', ['buyer-owned', 'seller-owned'], 'targeted buyer owner plus event seller owner', [], ['event.executeAction'], 'P-011/P-018/P-019'),
  ...
  event: pg('event', ['public', 'seller-owned'], 'seller owner; explicitly published public projection', ['events.guide', 'events.mine', 'event.stats'], ['event.setup', 'event.lifecycle', 'event.unpublish'], 'P-017/P-019'),
...
export const SYNC_QUERY_SURFACES: readonly NamedSurface[] = [
  ...
  query('inventory.page', 'catalog/catalog.module.ts', 'inventory', ['seller-owned'], ['storefront_product'], 'stable Studio store seller', 'P-019'),
...
export const SYNC_MUTATOR_SURFACES: readonly NamedSurface[] = [
  ...
  mutator('event.lifecycle', 'event-directory', ['seller-owned'], 'event seller owner', 'P-019'),
  mutator('event.setup', 'event-directory', ['seller-owned'], 'selected seller', 'P-019'),
  mutator('event.unpublish', 'event-directory', ['seller-owned'], 'event seller owner', 'P-019'),
