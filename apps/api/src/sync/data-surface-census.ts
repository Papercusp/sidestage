...
export const SYNC_QUERY_SURFACES: readonly NamedSurface[] = [
  ...
  query('event.chat.messages', 'chat/chat.module.ts', 'chat', ['public'], [], 'event room participant', 'P-017'),
  query('event.chat.presence', 'chat/chat.module.ts', 'chat-presence', ['public', 'streaming'], [], 'event room participant', 'P-017/P-020'),
  query('event.chat.stats', 'chat/chat.module.ts', 'chat-stats', ['public'], [], 'public projection', 'P-017'),
  query('event.chat.transcript', 'chat/chat.module.ts', 'transcript', ['public', 'seller-owned'], [], 'event visibility policy', 'P-017/P-019'),
  ...
  query('event.replay.chapters', 'chat/chat.module.ts', 'replay', ['public'], [], 'public event projection', 'P-017'),
...
export const PROCESS_LOCAL_SURFACES: readonly SourceSurface[] = [
  ...
  local('apps/api/src/chat/chat.service.ts', 'events', 'chat', ['public', 'streaming'], 'temporary authority', 'replicate', 'Postgres chat message/presence/replay tables', 'P-011/P-017/P-020'),
