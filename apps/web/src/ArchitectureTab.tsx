  ...
  return (
    <article className="tab-layout architecture-page" aria-labelledby="architecture-title">
      ...
      <section className="architecture-section" id="data-sync" aria-labelledby="data-sync-title">
        ...
        <div className="architecture-delivery-diagram" role="img" aria-label="The designed sync path: the shared Zero contract declares schema and queries, zero-cache replicates Postgres over logical replication, clients subscribe over one WebSocket, and writes flow through server-authoritative mutators back into Postgres. The WebSocket rung is not serving yet—SSE carries realtime state today.">
